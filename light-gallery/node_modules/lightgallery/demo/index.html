    ...
    <body class="home">
        ...
        <div class="demo-gallery">
            <ul id="lightgallery" class="list-unstyled row">
                ...
                <li class="col-xs-6 col-sm-4 col-md-3"  data-src="img/as.jpg" data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                  <a href="">
                      <img class="img-responsive" src="img/as.jpg"> 
                  </a>
              </li>
              <li class="col-xs-6 col-sm-4 col-md-3"  data-src="img/123123.jpg" data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="img/123123.jpg"> 
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3"  data-src="img/12.jpg" data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
              <a href="">
